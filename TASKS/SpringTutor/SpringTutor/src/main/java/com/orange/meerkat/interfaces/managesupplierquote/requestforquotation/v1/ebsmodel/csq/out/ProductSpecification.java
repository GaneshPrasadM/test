 ...
 *         &lt;element name="FunctionSpecification" type="{http://www.orange.com/Meerkat/Interfaces/ManageSupplierQuote/RequestForQuotation/v1/EBSModel/CSQ/Out}FunctionSpecification" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TariffSpecification" type="{http://www.orange.com/Meerkat/Interfaces/ManageSupplierQuote/RequestForQuotation/v1/EBSModel/CSQ/Out}TariffSpecification" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="SubNetwork" type="{http://www.orange.com/Meerkat/Interfaces/ManageSupplierQuote/RequestForQuotation/v1/EBSModel/CSQ/Out}SubNetwork" minOccurs="0"/&gt;
 *         &lt;element name="siteAccessType" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
 *         &lt;element name="Local_EligibilityDecision" type="{http://www.orange.com/Meerkat/Interfaces/ManageSupplierQuote/RequestForQuotation/v1/EBSModel/CSQ/Out}EligibilityDecision" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ProductSpecification {
    ...
    @XmlElement(name = "siteAccessType")
    protected String siteAccessType;
	...
	public String getSiteAccessType() {
		return siteAccessType;
	}

	public void setSiteAccessType(String siteAccessType) {
